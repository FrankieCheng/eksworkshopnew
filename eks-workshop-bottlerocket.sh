...
sed 's/$AWS_REGION/'"${AWS_REGION}"'/g' eksworkshopnew/yamls/ekscluster-nodegroup-bottlerocket-template.yaml > eksworkshopnew/yamls/ekscluster-nodegroup-bottlerocket.yaml

# create bottlerocket nodegroup.
eksctl create nodegroup --config-file eksworkshopnew/yamls/ekscluster-nodegroup-bottlerocket.yaml
